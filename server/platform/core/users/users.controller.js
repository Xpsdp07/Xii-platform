...
const authJwt = require('../auth/jwt.service');
...
module.exports = {
    ...
    app: function () {
        ...
        // Platform doesn't need to check for SCADA project
        // This check will remain in SCADA adapter layer
        ...
        usersApp.get("/api/users", secureFnc, function (req, res) {
            ...
            if (res.statusCode === 403) {
                ...
                usersService.getUsers(req.query).then(result => {
        ...
        usersApp.post("/api/users", secureFnc, function (req, res, next) {
            ...
            if (res.statusCode === 403) {
                ...
                usersService.setUsers(req.body.params).then(function (data) {
                    res.end();
                }).catch(function (err) {
                    if (err.code) {
                        res.status(400).json({ error: err.code, message: err.message });
        ...
        usersApp.delete("/api/users", secureFnc, function (req, res, next) {
            ...
            if (res.statusCode === 403) {
                ...
                usersService.removeUsers(req.query.param).then(function (data) {
                    res.end();
                }).catch(function (err) {
                    if (err.code) {
                        res.status(400).json({ error: err.code, message: err.message });
        ...
        usersApp.get("/api/roles", secureFnc, function (req, res) {
            ...
            if (res.statusCode === 403) {
                ...
                usersService.getRoles(req.query).then(result => {
                    if (result) {
                        res.json(result);
                    } else {
                        res.end();
        ...
        usersApp.post("/api/roles", secureFnc, function (req, res, next) {
            ...
            if (res.statusCode === 403) {
                ...
                usersService.setRoles(req.body.params).then(function (data) {
                    res.end();
                }).catch(function (err) {
                    if (err.code) {
                        res.status(400).json({ error: err.code, message: err.message });
        ...
        usersApp.delete("/api/roles", secureFnc, function (req, res, next) {
            ...
            if (res.statusCode === 403) {
                ...
                usersService.removeRoles(JSON.parse(req.query.roles)).then(function (data) {
                    res.end();
                }).catch(function (err) {
                    if (err.code) {
                        res.status(400).json({ error: err.code, message: err.message });
